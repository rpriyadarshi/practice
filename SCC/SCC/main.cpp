...
int main(int argc, const char * argv[]) {
    Graph g;
//    const std::string filename("/Users/rohit/Documents/Development/practice/SCC/SCC-1f.txt");
//    const std::string filename("/Users/rohit/Documents/Development/practice/SCC/SCC-2.txt");
    const std::string filename("/Users/rohit/Documents/Development/practice/SCC/SCC.txt");
    g.read(filename);
    g.scc();
    g.dump();
